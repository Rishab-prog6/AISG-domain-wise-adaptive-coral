...
# Full PACS sweep for DWA_CORAL_ALIGNONLY (test_env 0,1,2,3 | 3000 steps).
# Uses the custom dwa_train_v2 entry point so original DomainBed files are
# left untouched.

DATA_DIR=./data
DATASET=PACS
ALG=DWA_CORAL_ALIGNONLY
STEPS=3000
CKPT=500
HPARAMS='{"resnet18": true, "resnet50_augmix": false, "dwa_coral_lambda": 0.3, "dwa_coral_beta": 0.0, "dwa_coral_tau": 0.5}'
